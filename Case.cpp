...
Case::Case(int _type, float _Dist_front, float _Taille,float _Dist_cristal, float _concentration, float _proba_cristallisation)
    : dist_front(_Dist_front), dist_cristal(_Dist_cristal), taille_crist_proche(_Taille), concentration(_concentration), proba_cristallisation(_proba_cristallisation), type(_type){}

Case::Case() : Case(-2,0,1e-9,1e-5,0, 0){}
